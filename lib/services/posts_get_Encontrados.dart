...
Future<List<Post>> fetchFoundPosts({String? postStatus, String? name}) async {
  try {
    ...
    final response = await http.get(
      Uri.parse('$ngrokLink/api/posts/found$query'),
      headers: {
    ...
    if (response.statusCode == 200) {
      ...
      throw Exception(
          'Failed to load found posts. Status code: ${response.statusCode}.');
    }
  } catch (e) {
    print('Error: $e');
